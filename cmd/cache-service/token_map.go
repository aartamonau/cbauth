...
func MaybeCreateInitialTokenMap() {
	...
	tm.Servers = []NodeId{MyNode}
	tm.Tokens = createTokens(MyNode)
...
func (tm TokenMap) UpdateServers(newServers []NodeId) {
	...
	tm.Servers = append([]NodeId(nil), newServers...)
	tm.Tokens = newTokens
...
func (tm TokenMap) Copy() *TokenMap {
	...
	cp.Servers = append([]NodeId(nil), tm.Servers...)
	cp.Tokens = append(TokenList(nil), tm.Tokens...)
